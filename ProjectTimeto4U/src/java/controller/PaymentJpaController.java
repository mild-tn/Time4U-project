...
public class PaymentJpaController implements Serializable {
    ...
    public void create(Payment payment) throws PreexistingEntityException, RollbackFailureException, Exception {
        ...
        try {
            utx.begin();
            em = getEntityManager();
            OrdersCustomer ordernumber = payment.getOrdernumber();
            if (ordernumber != null) {
            ...
            em.persist(payment);
            if (ordernumber != null) {
                ordernumber.getPaymentList().add(payment);
    ...
    public void destroy(String id) throws NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            OrdersCustomer ordernumber = payment.getOrdernumber();
            if (ordernumber != null) {
                ordernumber.getPaymentList().remove(payment);
                ordernumber = em.merge(ordernumber);
            }
            em.remove(payment);
            utx.commit();
